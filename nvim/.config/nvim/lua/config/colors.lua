...
hi('@lsp.type.variable',      { link = 'Identifier' })
  ...
  hi('CursorLine',   { bg = 'Grey18',                           cterm = { underline = true } })
  hi('CursorLineNr', { fg = '#f5b8eb', bold = true,                 ctermfg = 'White', cterm = { underline = true } })
